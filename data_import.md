...
``` r
## use clean_name function from janitor package
...
``` r
## relatively path is earier and better
...
litters_df =
 read_csv(
   ...
   na = c("NA", "",".")
   # skip = 2, can skip first several lines in csv
 )
```
